...
cancelKeyDeletion :: forall eff. CancelKeyDeletionRequest -> Aff (err :: AWS.RequestError | eff) CancelKeyDeletionResponse
cancelKeyDeletion = AWS.request serviceName "CancelKeyDeletion" 
...
createAlias :: forall eff. CreateAliasRequest -> Aff (err :: AWS.RequestError | eff) Unit
...
createGrant :: forall eff. CreateGrantRequest -> Aff (err :: AWS.RequestError | eff) CreateGrantResponse
createGrant = AWS.request serviceName "CreateGrant" 
...
createKey :: forall eff. CreateKeyRequest -> Aff (err :: AWS.RequestError | eff) CreateKeyResponse
createKey = AWS.request serviceName "CreateKey" 
...
decrypt :: forall eff. DecryptRequest -> Aff (err :: AWS.RequestError | eff) DecryptResponse
decrypt = AWS.request serviceName "Decrypt" 
...
deleteAlias :: forall eff. DeleteAliasRequest -> Aff (err :: AWS.RequestError | eff) Unit
...
deleteImportedKeyMaterial :: forall eff. DeleteImportedKeyMaterialRequest -> Aff (err :: AWS.RequestError | eff) Unit
deleteImportedKeyMaterial = AWS.request serviceName "DeleteImportedKeyMaterial" 
...
describeKey :: forall eff. DescribeKeyRequest -> Aff (err :: AWS.RequestError | eff) DescribeKeyResponse
describeKey = AWS.request serviceName "DescribeKey" 
...
disableKey :: forall eff. DisableKeyRequest -> Aff (err :: AWS.RequestError | eff) Unit
disableKey = AWS.request serviceName "DisableKey" 
...
disableKeyRotation :: forall eff. DisableKeyRotationRequest -> Aff (err :: AWS.RequestError | eff) Unit
disableKeyRotation = AWS.request serviceName "DisableKeyRotation" 
...
enableKey :: forall eff. EnableKeyRequest -> Aff (err :: AWS.RequestError | eff) Unit
enableKey = AWS.request serviceName "EnableKey" 
...
enableKeyRotation :: forall eff. EnableKeyRotationRequest -> Aff (err :: AWS.RequestError | eff) Unit
enableKeyRotation = AWS.request serviceName "EnableKeyRotation" 
...
encrypt :: forall eff. EncryptRequest -> Aff (err :: AWS.RequestError | eff) EncryptResponse
encrypt = AWS.request serviceName "Encrypt" 
...
generateDataKey :: forall eff. GenerateDataKeyRequest -> Aff (err :: AWS.RequestError | eff) GenerateDataKeyResponse
generateDataKey = AWS.request serviceName "GenerateDataKey" 
...
generateDataKeyWithoutPlaintext :: forall eff. GenerateDataKeyWithoutPlaintextRequest -> Aff (err :: AWS.RequestError | eff) GenerateDataKeyWithoutPlaintextResponse
generateDataKeyWithoutPlaintext = AWS.request serviceName "GenerateDataKeyWithoutPlaintext" 
...
generateRandom :: forall eff. GenerateRandomRequest -> Aff (err :: AWS.RequestError | eff) GenerateRandomResponse
generateRandom = AWS.request serviceName "GenerateRandom" 
...
getKeyPolicy :: forall eff. GetKeyPolicyRequest -> Aff (err :: AWS.RequestError | eff) GetKeyPolicyResponse
getKeyPolicy = AWS.request serviceName "GetKeyPolicy" 
...
getKeyRotationStatus :: forall eff. GetKeyRotationStatusRequest -> Aff (err :: AWS.RequestError | eff) GetKeyRotationStatusResponse
getKeyRotationStatus = AWS.request serviceName "GetKeyRotationStatus" 
...
getParametersForImport :: forall eff. GetParametersForImportRequest -> Aff (err :: AWS.RequestError | eff) GetParametersForImportResponse
getParametersForImport = AWS.request serviceName "GetParametersForImport" 
...
importKeyMaterial :: forall eff. ImportKeyMaterialRequest -> Aff (err :: AWS.RequestError | eff) ImportKeyMaterialResponse
importKeyMaterial = AWS.request serviceName "ImportKeyMaterial" 
...
listGrants :: forall eff. ListGrantsRequest -> Aff (err :: AWS.RequestError | eff) ListGrantsResponse
listGrants = AWS.request serviceName "ListGrants" 
...
listKeyPolicies :: forall eff. ListKeyPoliciesRequest -> Aff (err :: AWS.RequestError | eff) ListKeyPoliciesResponse
listKeyPolicies = AWS.request serviceName "ListKeyPolicies" 


-- | <p>Gets a list of all customer master keys (CMKs) in the caller's AWS account and region.</p>
listKeys :: forall eff. ListKeysRequest -> Aff (err :: AWS.RequestError | eff) ListKeysResponse
listKeys = AWS.request serviceName "ListKeys" 
...
listResourceTags :: forall eff. ListResourceTagsRequest -> Aff (err :: AWS.RequestError | eff) ListResourceTagsResponse
listResourceTags = AWS.request serviceName "ListResourceTags" 
...
listRetirableGrants :: forall eff. ListRetirableGrantsRequest -> Aff (err :: AWS.RequestError | eff) ListGrantsResponse
listRetirableGrants = AWS.request serviceName "ListRetirableGrants" 
...
putKeyPolicy :: forall eff. PutKeyPolicyRequest -> Aff (err :: AWS.RequestError | eff) Unit
putKeyPolicy = AWS.request serviceName "PutKeyPolicy" 
...
reEncrypt :: forall eff. ReEncryptRequest -> Aff (err :: AWS.RequestError | eff) ReEncryptResponse
reEncrypt = AWS.request serviceName "ReEncrypt" 
...
retireGrant :: forall eff. RetireGrantRequest -> Aff (err :: AWS.RequestError | eff) Unit
retireGrant = AWS.request serviceName "RetireGrant" 
...
revokeGrant :: forall eff. RevokeGrantRequest -> Aff (err :: AWS.RequestError | eff) Unit
revokeGrant = AWS.request serviceName "RevokeGrant" 
...
scheduleKeyDeletion :: forall eff. ScheduleKeyDeletionRequest -> Aff (err :: AWS.RequestError | eff) ScheduleKeyDeletionResponse
scheduleKeyDeletion = AWS.request serviceName "ScheduleKeyDeletion" 
...
updateAlias :: forall eff. UpdateAliasRequest -> Aff (err :: AWS.RequestError | eff) Unit
...
updateKeyDescription :: forall eff. UpdateKeyDescriptionRequest -> Aff (err :: AWS.RequestError | eff) Unit
updateKeyDescription = AWS.request serviceName "UpdateKeyDescription" 
